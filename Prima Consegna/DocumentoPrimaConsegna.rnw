...
Il programma \'e stato sviluppato per scaricare un numero variabile di pagine dei risultati da Google (nel mio caso tutti gli atricoli riguardanti la parola chiave "crisi" presenti sul sito \url{www.repubblica.it} ) e rielabora le pagine passate come risultati per fare un conteggio delle frequenza delle parole presenti nel sito.
